...
class ActiveImageControl(wx.Control):
    ...
    def draw_highlight(self, context, adjustment):
        ...
        for RGBA, width, i_offset, rect, cnr_rad in [
            ...
            ((c_r, c_g, c_b, c_a - 155), 1, (0, 0), self.GetRect().Deflate(sizing), 4),
            ((c_r, c_g, c_b, c_a - 200), 1, (1, 1), self.GetRect().Deflate(sizing[0] + 1, sizing[1] + 1), 4)
        ]:
            r, g, b, a = RGBA
            ...
            rect.SetPosition(offset + i_offset + sizing)
